...
<header class="nav">
  <div class="wrap">
    <a class="brand" href="/"><svg viewBox="0 0 32 32" aria-hidden="true"><path d="M5.5 27.5 L16 5 L26.5 27.5" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 13.8 Q16.7 19.3 22.2 20 Q16.7 20.7 16 26.2 Q15.3 20.7 9.8 20 Q15.3 19.3 16 13.8Z" fill="#FF5A1F"/></svg>AgntSpark</a>
    <nav>{nav}</nav>
  </div>
</header>
<main>
